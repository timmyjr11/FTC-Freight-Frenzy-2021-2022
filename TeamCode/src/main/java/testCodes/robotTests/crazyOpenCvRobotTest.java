...
@Autonomous
public class crazyOpenCvRobotTest extends LinearOpMode {
   ...
   // public static double centerOfCam = 120;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        while (opModeIsActive()) {
            sleep(20);
            ArrayList<contourPipe.AnalyzedDuck> ducks = pipeline.getDetectedDucks();
    ...
    static class contourPipe extends OpenCvPipeline
    {
        ...
        public ArrayList<AnalyzedDuck> getDetectedDucks()
        {
        ...
        void analyzeContour(MatOfPoint contour, Mat input)
        {
            ...
            double cordX = rotatedRectFitToContour.center.x;
            double cordY = rotatedRectFitToContour.center.y;
            ...
            if(aboveMidlineMetrics.density < belowMidlineMetrics.density - DENSITY_UPRIGHT_THRESHOLD)
            {
                ...
                drawTagTextX(rotatedRectFitToContour, (double) Math.round(cordX) +" X", input);
                drawTagTextY(rotatedRectFitToContour, (double) Math.round(cordY) + " Y", input);
                AnalyzedDuck.CordX = cordX;
                AnalyzedDuck.CordY = cordY;
        ...
        static ContourRegionAnalysis analyzeContourRegion(ArrayList<Point> contourPoints)
        {
            ...
            List<MatOfPoint> listHolderOfMatOfPoint = Collections.singletonList(matOfPoint);
